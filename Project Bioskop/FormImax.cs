...
{
    public partial class FormImax : Form
    {
		...
		{
			if (btnC19.BackColor == Color.Yellow)
			{
				btnC19.BackColor = Color.PaleGreen;
			}
			else
			{
				btnC19.BackColor = Color.Yellow;
			}
		}
		...
		{
			if (btnH11.BackColor == Color.Yellow)
			{
				btnH11.BackColor = Color.PaleGreen;
			}
			else
			{
				btnH11.BackColor = Color.Yellow;
			}
		}
