...
namespace Project_Bioskop
{
	public partial class FormThePremiere : Form
	{
        ...
        {
            if (btnA19.BackColor == Color.Yellow)
            {
                btnA19.BackColor = Color.PaleGreen;
            }
            else
            {
                btnA19.BackColor = Color.Yellow;
            }
        }

        private void btnA20_Click(object sender, EventArgs e)
        {
            if (btnA20.BackColor == Color.Yellow)
            {
                btnA20.BackColor = Color.PaleGreen;
            }
            else
            {
                btnA20.BackColor = Color.Yellow;
            }
        }

        private void btnA21_Click(object sender, EventArgs e)
        {
            if (btnA21.BackColor == Color.Yellow)
            {
                btnA21.BackColor = Color.PaleGreen;
            }
            else
            {
                btnA21.BackColor = Color.Yellow;
            }
        }

        private void btnA22_Click(object sender, EventArgs e)
        {
            if (btnA22.BackColor == Color.Yellow)
            {
                btnA22.BackColor = Color.PaleGreen;
            }
            else
            {
                btnA22.BackColor = Color.Yellow;
            }
        }

        private void btnA23_Click(object sender, EventArgs e)
        {
            if (btnA23.BackColor == Color.Yellow)
            {
                btnA23.BackColor = Color.PaleGreen;
            }
            else
            {
                btnA23.BackColor = Color.Yellow;
            }
        }

        private void btnA24_Click(object sender, EventArgs e)
        {
            if (btnA24.BackColor == Color.Yellow)
            {
                btnA24.BackColor = Color.PaleGreen;
            }
            else
            {
                btnA24.BackColor = Color.Yellow;
            }
        }

        private void btnA25_Click(object sender, EventArgs e)
        {
            if (btnA25.BackColor == Color.Yellow)
            {
                btnA25.BackColor = Color.PaleGreen;
            }
            else
            {
                btnA25.BackColor = Color.Yellow;
            }
        }
        ...
        {
            if (btnB19.BackColor == Color.Yellow)
            {
                btnB19.BackColor = Color.PaleGreen;
            }
            else
            {
                btnB19.BackColor = Color.Yellow;
            }
        }

        private void btnB20_Click(object sender, EventArgs e)
        {
            if (btnB20.BackColor == Color.Yellow)
            {
                btnB20.BackColor = Color.PaleGreen;
            }
            else
            {
                btnB20.BackColor = Color.Yellow;
            }
        }

        private void btnB21_Click(object sender, EventArgs e)
        {
            if (btnB21.BackColor == Color.Yellow)
            {
                btnB21.BackColor = Color.PaleGreen;
            }
            else
            {
                btnB21.BackColor = Color.Yellow;
            }
        }

        private void btnB22_Click(object sender, EventArgs e)
        {
            if (btnB22.BackColor == Color.Yellow)
            {
                btnB22.BackColor = Color.PaleGreen;
            }
            else
            {
                btnB22.BackColor = Color.Yellow;
            }
        }

        private void btnB23_Click(object sender, EventArgs e)
        {
            if (btnB23.BackColor == Color.Yellow)
            {
                btnB23.BackColor = Color.PaleGreen;
            }
            else
            {
                btnB23.BackColor = Color.Yellow;
            }
        }

        private void btnB24_Click(object sender, EventArgs e)
        {
            if (btnB24.BackColor == Color.Yellow)
            {
                btnB24.BackColor = Color.PaleGreen;
            }
            else
            {
                btnB24.BackColor = Color.Yellow;
            }
        }

        private void btnB25_Click(object sender, EventArgs e)
        {
            if (btnB25.BackColor == Color.Yellow)
            {
                btnB25.BackColor = Color.PaleGreen;
            }
            else
            {
                btnB25.BackColor = Color.Yellow;
            }
        }
        ...
        private void btcC19_Click(object sender, EventArgs e)
        {
            if (btcC19.BackColor == Color.Yellow)
            {
                btcC19.BackColor = Color.PaleGreen;
            }
            else
            {
                btcC19.BackColor = Color.Yellow;
            }
        }

        private void btnC20_Click(object sender, EventArgs e)
        {
            if (btnC20.BackColor == Color.Yellow)
            {
                btnC20.BackColor = Color.PaleGreen;
            }
            else
            {
                btnC20.BackColor = Color.Yellow;
            }
        }

        private void btnC21_Click(object sender, EventArgs e)
        {
            if (btnC21.BackColor == Color.Yellow)
            {
                btnC21.BackColor = Color.PaleGreen;
            }
            else
            {
                btnC21.BackColor = Color.Yellow;
            }
        }

        private void btnC22_Click(object sender, EventArgs e)
        {
            if (btnC22.BackColor == Color.Yellow)
            {
                btnC22.BackColor = Color.PaleGreen;
            }
            else
            {
                btnC22.BackColor = Color.Yellow;
            }
        }

        private void btnC23_Click(object sender, EventArgs e)
        {
            if (btnC23.BackColor == Color.Yellow)
            {
                btnC23.BackColor = Color.PaleGreen;
            }
            else
            {
                btnC23.BackColor = Color.Yellow;
            }
        }

        private void btnC24_Click(object sender, EventArgs e)
        {
            if (btnC24.BackColor == Color.Yellow)
            {
                btnC24.BackColor = Color.PaleGreen;
            }
            else
            {
                btnC24.BackColor = Color.Yellow;
            }
        }

        private void btnC25_Click(object sender, EventArgs e)
        {
            if (btnC25.BackColor == Color.Yellow)
            {
                btnC25.BackColor = Color.PaleGreen;
            }
            else
            {
                btnC25.BackColor = Color.Yellow;
            }
        }
        ...
        {
            if (btnD19.BackColor == Color.Yellow)
            {
                btnD19.BackColor = Color.PaleGreen;
            }
            else
            {
                btnD19.BackColor = Color.Yellow;
            }
        }

        private void btnD20_Click(object sender, EventArgs e)
        {
            if (btnD20.BackColor == Color.Yellow)
            {
                btnD20.BackColor = Color.PaleGreen;
            }
            else
            {
                btnD20.BackColor = Color.Yellow;
            }
        }

        private void btnD21_Click(object sender, EventArgs e)
        {
            if (btnD21.BackColor == Color.Yellow)
            {
                btnD21.BackColor = Color.PaleGreen;
            }
            else
            {
                btnD21.BackColor = Color.Yellow;
            }
        }

        private void btnD22_Click(object sender, EventArgs e)
        {
            if (btnD22.BackColor == Color.Yellow)
            {
                btnD22.BackColor = Color.PaleGreen;
            }
            else
            {
                btnD22.BackColor = Color.Yellow;
            }
        }

        private void btnD23_Click(object sender, EventArgs e)
        {
            if (btnD23.BackColor == Color.Yellow)
            {
                btnD23.BackColor = Color.PaleGreen;
            }
            else
            {
                btnD23.BackColor = Color.Yellow;
            }
        }

        private void btnD24_Click(object sender, EventArgs e)
        {
            if (btnD24.BackColor == Color.Yellow)
            {
                btnD24.BackColor = Color.PaleGreen;
            }
            else
            {
                btnD24.BackColor = Color.Yellow;
            }
        }

        private void btnD25_Click(object sender, EventArgs e)
        {
            if (btnD25.BackColor == Color.Yellow)
            {
                btnD25.BackColor = Color.PaleGreen;
            }
            else
            {
                btnD25.BackColor = Color.Yellow;
            }
        }
        ...
        private void btnE19_Click(object sender, EventArgs e)
        {
            if (btnE19.BackColor == Color.Yellow)
            {
                btnE19.BackColor = Color.PaleGreen;
            }
            else
            {
                btnE19.BackColor = Color.Yellow;
            }
        }

        private void btnE20_Click(object sender, EventArgs e)
        {
            if (btnE20.BackColor == Color.Yellow)
            {
                btnE20.BackColor = Color.PaleGreen;
            }
            else
            {
                btnE20.BackColor = Color.Yellow;
            }
        }

        private void btnE21_Click(object sender, EventArgs e)
        {
            if (btnE21.BackColor == Color.Yellow)
            {
                btnE21.BackColor = Color.PaleGreen;
            }
            else
            {
                btnE21.BackColor = Color.Yellow;
            }
        }

        private void btnE22_Click(object sender, EventArgs e)
        {
            if (btnE22.BackColor == Color.Yellow)
            {
                btnE22.BackColor = Color.PaleGreen;
            }
            else
            {
                btnE22.BackColor = Color.Yellow;
            }
        }

        private void btnE23_Click(object sender, EventArgs e)
        {
            if (btnE23.BackColor == Color.Yellow)
            {
                btnE23.BackColor = Color.PaleGreen;
            }
            else
            {
                btnE23.BackColor = Color.Yellow;
            }
        }

        private void btnE24_Click(object sender, EventArgs e)
        {
            if (btnE24.BackColor == Color.Yellow)
            {
                btnE24.BackColor = Color.PaleGreen;
            }
            else
            {
                btnE24.BackColor = Color.Yellow;
            }
        }

        private void btnE25_Click(object sender, EventArgs e)
        {
            if (btnE25.BackColor == Color.Yellow)
            {
                btnE25.BackColor = Color.PaleGreen;
            }
            else
            {
                btnE25.BackColor = Color.Yellow;
            }
        }
        ...
        {
            if (btnF19.BackColor == Color.Yellow)
            {
                btnF19.BackColor = Color.PaleGreen;
            }
            else
            {
                btnF19.BackColor = Color.Yellow;
            }
        }

        private void btnF20_Click(object sender, EventArgs e)
        {
            if (btnF20.BackColor == Color.Yellow)
            {
                btnF20.BackColor = Color.PaleGreen;
            }
            else
            {
                btnF20.BackColor = Color.Yellow;
            }
        }

        private void btnF21_Click(object sender, EventArgs e)
        {
            if (btnF21.BackColor == Color.Yellow)
            {
                btnF21.BackColor = Color.PaleGreen;
            }
            else
            {
                btnF21.BackColor = Color.Yellow;
            }
        }

        private void btnF22_Click(object sender, EventArgs e)
        {
            if (btnF22.BackColor == Color.Yellow)
            {
                btnF22.BackColor = Color.PaleGreen;
            }
            else
            {
                btnF22.BackColor = Color.Yellow;
            }
        }

        private void btnF23_Click(object sender, EventArgs e)
        {
            if (btnF23.BackColor == Color.Yellow)
            {
                btnF23.BackColor = Color.PaleGreen;
            }
            else
            {
                btnF23.BackColor = Color.Yellow;
            }
        }

        private void btnF24_Click(object sender, EventArgs e)
        {
            if (btnF24.BackColor == Color.Yellow)
            {
                btnF24.BackColor = Color.PaleGreen;
            }
            else
            {
                btnF24.BackColor = Color.Yellow;
            }
        }

        private void btnF25_Click(object sender, EventArgs e)
        {
            if (btnF25.BackColor == Color.Yellow)
            {
                btnF25.BackColor = Color.PaleGreen;
            }
            else
            {
                btnF25.BackColor = Color.Yellow;
            }
        }
        ...
        private void btnG19_Click(object sender, EventArgs e)
        {
            if (btnG19.BackColor == Color.Yellow)
            {
                btnG19.BackColor = Color.PaleGreen;
            }
            else
            {
                btnG19.BackColor = Color.Yellow;
            }
        }

        private void btnG20_Click(object sender, EventArgs e)
        {
            if (btnG20.BackColor == Color.Yellow)
            {
                btnG20.BackColor = Color.PaleGreen;
            }
            else
            {
                btnG20.BackColor = Color.Yellow;
            }
        }

        private void btnG21_Click(object sender, EventArgs e)
        {
            if (btnG21.BackColor == Color.Yellow)
            {
                btnG21.BackColor = Color.PaleGreen;
            }
            else
            {
                btnG21.BackColor = Color.Yellow;
            }
        }

        private void btnG22_Click(object sender, EventArgs e)
        {
            if (btnG22.BackColor == Color.Yellow)
            {
                btnG22.BackColor = Color.PaleGreen;
            }
            else
            {
                btnG22.BackColor = Color.Yellow;
            }
        }

        private void btnG23_Click(object sender, EventArgs e)
        {
            if (btnG23.BackColor == Color.Yellow)
            {
                btnG23.BackColor = Color.PaleGreen;
            }
            else
            {
                btnG23.BackColor = Color.Yellow;
            }
        }

        private void btnG24_Click(object sender, EventArgs e)
        {
            if (btnG24.BackColor == Color.Yellow)
            {
                btnG24.BackColor = Color.PaleGreen;
            }
            else
            {
                btnG24.BackColor = Color.Yellow;
            }
        }

        private void btnG25_Click(object sender, EventArgs e)
        {
            if (btnG25.BackColor == Color.Yellow)
            {
                btnG25.BackColor = Color.PaleGreen;
            }
            else
            {
                btnG25.BackColor = Color.Yellow;
            }
        }

        private void btnH1_Click(object sender, EventArgs e)
        {
            if (btnH1.BackColor == Color.Yellow)
            {
                btnH1.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH1.BackColor = Color.Yellow;
            }
        }

        private void btnH2_Click(object sender, EventArgs e)
        {
            if (btnH2.BackColor == Color.Yellow)
            {
                btnH2.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH2.BackColor = Color.Yellow;
            }
        }

        private void btnH3_Click(object sender, EventArgs e)
        {
            if (btnH3.BackColor == Color.Yellow)
            {
                btnH3.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH3.BackColor = Color.Yellow;
            }
        }

        private void btnH4_Click(object sender, EventArgs e)
        {
            if (btnH4.BackColor == Color.Yellow)
            {
                btnH4.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH4.BackColor = Color.Yellow;
            }
        }

        private void btnH5_Click(object sender, EventArgs e)
        {
            if (btnH5.BackColor == Color.Yellow)
            {
                btnH5.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH5.BackColor = Color.Yellow;
            }
        }

        private void btnH6_Click(object sender, EventArgs e)
        {
            if (btnH6.BackColor == Color.Yellow)
            {
                btnH6.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH6.BackColor = Color.Yellow;
            }
        }

        private void btnH7_Click(object sender, EventArgs e)
        {
            if (btnH7.BackColor == Color.Yellow)
            {
                btnH7.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH7.BackColor = Color.Yellow;
            }
        }

        private void btnH8_Click(object sender, EventArgs e)
        {
            if (btnH8.BackColor == Color.Yellow)
            {
                btnH8.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH8.BackColor = Color.Yellow;
            }
        }

        private void btnH9_Click(object sender, EventArgs e)
        {
            if (btnH9.BackColor == Color.Yellow)
            {
                btnH9.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH9.BackColor = Color.Yellow;
            }
        }

        private void btnH10_Click(object sender, EventArgs e)
        {
            if (btnH10.BackColor == Color.Yellow)
            {
                btnH10.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH10.BackColor = Color.Yellow;
            }
        }

        private void buttonH11_Click(object sender, EventArgs e)
        {
            if (buttonH11.BackColor == Color.Yellow)
            {
                buttonH11.BackColor = Color.PaleGreen;
            }
            else
            {
                buttonH11.BackColor = Color.Yellow;
            }
        }

        private void btnH12_Click(object sender, EventArgs e)
        {
            if (btnH12.BackColor == Color.Yellow)
            {
                btnH12.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH12.BackColor = Color.Yellow;
            }
        }

        private void btnH13_Click(object sender, EventArgs e)
        {
            if (btnH13.BackColor == Color.Yellow)
            {
                btnH13.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH13.BackColor = Color.Yellow;
            }
        }

        private void btnH14_Click(object sender, EventArgs e)
        {
            if (btnH14.BackColor == Color.Yellow)
            {
                btnH14.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH14.BackColor = Color.Yellow;
            }
        }

        private void btnH15_Click(object sender, EventArgs e)
        {
            if (btnH15.BackColor == Color.Yellow)
            {
                btnH15.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH15.BackColor = Color.Yellow;
            }
        }

        private void btnH16_Click(object sender, EventArgs e)
        {
            if (btnH16.BackColor == Color.Yellow)
            {
                btnH16.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH16.BackColor = Color.Yellow;
            }
        }

        private void btnH17_Click(object sender, EventArgs e)
        {
            if (btnH17.BackColor == Color.Yellow)
            {
                btnH17.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH17.BackColor = Color.Yellow;
            }
        }

        private void btnH18_Click(object sender, EventArgs e)
        {
            if (btnH18.BackColor == Color.Yellow)
            {
                btnH18.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH18.BackColor = Color.Yellow;
            }
        }

        private void btnH19_Click(object sender, EventArgs e)
        {
            if (btnH19.BackColor == Color.Yellow)
            {
                btnH19.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH19.BackColor = Color.Yellow;
            }
        }

        private void btnH20_Click(object sender, EventArgs e)
        {
            if (btnH20.BackColor == Color.Yellow)
            {
                btnH20.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH20.BackColor = Color.Yellow;
            }
        }

        private void btnH21_Click(object sender, EventArgs e)
        {
            if (btnH21.BackColor == Color.Yellow)
            {
                btnH21.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH21.BackColor = Color.Yellow;
            }
        }

        private void btnH22_Click(object sender, EventArgs e)
        {
            if (btnH22.BackColor == Color.Yellow)
            {
                btnH22.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH22.BackColor = Color.Yellow;
            }
        }

        private void btnH23_Click(object sender, EventArgs e)
        {
            if (btnH23.BackColor == Color.Yellow)
            {
                btnH23.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH23.BackColor = Color.Yellow;
            }
        }

        private void btnH24_Click(object sender, EventArgs e)
        {
            if (btnH24.BackColor == Color.Yellow)
            {
                btnH24.BackColor = Color.PaleGreen;
            }
            else
            {
                btnH24.BackColor = Color.Yellow;
            }
        }

        private void btnH25_Click(object sender, EventArgs e)
        {
            if (btnH25.BackColor == Color.Yellow)
            {
                btnH25.BackColor = Color.PaleGreen;
            }
            else
            {
